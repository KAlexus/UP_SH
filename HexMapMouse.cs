...
public class HexMapMouse : MonoBehaviour {
	...
	void Update () {
        ...
        if (Physics.Raycast(ray, out hit, Mathf.Infinity)) //&& Input.GetKeyDown(KeyCode.Mouse0)
        {
            ...
            //int size = hexGenerator.hexSize * 2;
            //currentSelectedHex = _PixelToHex(hit.point, hexSize);
            ///Debug.Log("Current HEX[" + hit.point.x + "," + hit.point.z + "]");
           ...
           // p3 = hitTransform.TransformPoint(p3);
            ...
            //p6 = hitTransform.TransformPoint(p6);
